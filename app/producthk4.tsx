...
<span className='border-1-8 border-red-400 text-red-600 mb-5 font-bold' >Top Category</span>
...
< Image src={wingchair} alt ='hero-image' width={150} height={100} ></Image>
</div>
{/*title*/}
...
< Image src={woodenchair} alt ='hero-image' width={150} height={100} ></Image>
</div>
{/*title*/}
<div className="flex flex-col">
<span className="text-lg font-bold">
...
< Image src={stole1} alt ='hero-image' width={150} height={100} ></Image>
</div>
